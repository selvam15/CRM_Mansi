            ...
            <div className="container mx-auto px-6">
                ...
                <div className={`flex flex-col md:flex-row items-center justify-center gap-12 bg-slate-100 p-8 md:p-12 rounded-lg shadow-lg transition-all duration-700 ease-out delay-200 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
                    <div className="flex-shrink-0">
                        <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhicUA5YuUe1aBO54v1uPddn-2LP9B3oCOD7oAhAMMLzYnube1T8cvh_Rg-QoBi0ClbANeZCPwbLhm4N1JCozl0wKj5NSwP6qOeisD3b7Am_8xh-lBlz533NatVMuxOP0bdNdFSYpD9EG3Zk42nzfnDwtIrnCwDXJMqjShLWlu85Hcsnp7n5u9EPAuSSWeH/s456/WhatsApp%20Image%202025-11-02%20at%203.39.16%20PM.jpeg" alt="Hardhik Chowdary" className="w-48 h-48 rounded-full object-cover shadow-xl border-4 border-white transition-transform duration-300 hover:scale-105"/>
                    </div>
